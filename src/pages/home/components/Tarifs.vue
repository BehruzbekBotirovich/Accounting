<template>
    ...
    <h1 class="main-container text-xl md:text-4xl font-bold uppercase mt-16">Тарифы и входящие в них услуги </h1>
    <div class="md:flex main-container pt-8 pb-16" id="tarifs">
        <!-- navbar desctop -->
        <div class="  md:w-1/3 bg-blue-900 text-white  rounded-s-xl ">
        ...
        <!-- info part  -->
        <div class="md:w-3/4 md:p-4 h-fit">
