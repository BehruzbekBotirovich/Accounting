    ...
    <div class="relative md:flex pt-20 bg-neutral-300  p-2 md:p-0" id="contacts">
        ...
        <div class="bg-white py-6 px-10 md:w-1/3 space-y-6  h-fit md:-translate-x-20 md:-translate-y-10 shadow-md rounded-xl">
            ...
            <div class="flex gap-4  ">
                <div class="p-3 border rounded h-fit">
                    <svg width="1.5rem" height="1.5rem" viewBox="0 0 24 24" fill="none"
                        ...
                        <path d="M14 2C14 2 16.2 2.2 19 5C21.8 7.8 22 10 22 10" stroke="#1e40af" stroke-width="1.5"
                ...
                <p class="font-semibold pt-">Telefon <br>
            ...
            <div class="flex gap-4 ">
                ...
                <p class="font-semibold pt-">Адресс <br>
                    <a href="#" class="font-normal "> Россия, 125040, г. Москва, ул. Большая Пироговская 18/1</a>
                </p>
            </div>
                ...
                <div class="p-3 border rounded h-fit">
                    <svg width="1.5rem" height="1.5rem" viewBox="0 0 24 24" fill="none"
                        ...
                        <path
                            ...
                            stroke="#1e40af" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path d="M17 9L13.87 11.5C12.84 12.32 11.15 12.32 10.12 11.5L7 9" stroke="#1e40af"
                            stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                </div>
                <p class="font-semibold pt-">Email <br>
            ...
            <div class="flex gap-4 ">
                ...
                <p class="font-semibold pt-">График работы <br>
                    <a href="#" class="font-normal text-blue-700"> beha@gmail.com</a>
                </p>
            </div>
