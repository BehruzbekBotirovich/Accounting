<template>
    <div class="w-fit">
        <svg version="1.1" id="svg2" xmlns:dc="http://purl.org/dc/elements/1.1/"
            ...
            xmlns:xlink="http://www.w3.org/1999/xlink" width="40px" height="40px" viewBox="0 0 1200 1200"
            enable-background="new 0 0 1200 1200" xml:space="preserve">
            <path id="path17923" inkscape:connector-curvature="0" d="M518.474,105.344C305.831,120.286,0.168,154.236,0,570.687v523.97h474.504
	...
	L1154.198,105.344L1154.198,105.344z" />
        </svg>
    </div>
</template>
